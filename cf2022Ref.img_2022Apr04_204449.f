\ .\cf2022\cf2022Ref.img converted by colorForthScan V1.0 2022 Mar 27
\ File MD5 = 98E9C621E1279433F27457AA0952E2DD  crocks-globular     

\ MagentaV  is the colorForth Magenta Variable 
: MagentaV ( initial -- )   create , ; \ Runtime: ( -- a ) 

\ Block 64 
( colorforth cf2022 2022 Apr 04 ) 
( processor clock ) #0 MagentaV mhz #0 MagentaV khz 
( dump ) #1601536 MagentaV x #0 MagentaV y ( ld ) #506 MagentaV lblk 
#2 #12 +thru
: dump #78 load ;
: icons #80 ld ;        : print #84 ld ;
...
: chm ( -- ) #0 mhz ! #0 khz ! $1740 x ! #0 y ! $00010000
...
\ ( This block gets loaded at power up. F1 for help. )
...
: calkhz ( -- ) hi lo time hi lo time - u2/ #250 + #500 / 
dup khz ! ;
...
: ok show page cursor #18 dup at ikon text blue #80 #450 at    ef #96 #474 box #80 #450 at white    ef ic @ dup emit space 
dup green . $30 emit $78 emit #2 h.n keypad ; 
...
nul nul nul nul         nul nul nul toggle 
   nul nul nul nul 
$2500 , $13121110 dup , , $2B00002D , #0 , $02000000 , #0 , 
...
: ok show page text #15 #16 lines cr ymd . hms . keypad ;
: h 
...
#179200 MagentaV x #115316379 MagentaV y #299999 MagentaV inc 
#35 MagentaV dep #33554432 MagentaV frame #0 MagentaV hole
...
\ Block 278 
( App: colorforth Explorer ) empty #-7 MagentaV strt
...
serve  
: .   n   n   y   s   n   n   n   n   n   ;  
: s   u   $0110160C   ( -- )   col   #-1   +!   #1   

\ Block 509 
\ ( Block ) #508 ( is the editor delete buffer ) 
