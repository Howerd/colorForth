; cf2019.nasm 2019 Sep 14  "rachis-cascade" (512K byte image size) with arrow, Enter and Escape keys
...
colour_taupe        equ 0xB2E7
colour_taupeData    equ 0xB2E7
...
newActions:
    dd nul, imm0, nul, nul, nul, nul, nul, nul, nul, txt0, nul, nul, mvar0, nul, nul, taupe0
...
oldActions:
    dd nul, imm1, nul, nul, nul, nul, nul, nul, nul, txt1, nul, nul, mvar1, nul, nul, taupe1
...
taupeString:    ; display a taupe string using the following 32 bit pre-parsed cell
    mov dword [ x_numberDisplay ], dotDecimal
    cmp dword [ base ], byte 0x0A   ; check the current BASE value ( 10 or 16 for decimal or hex)
    jz .forward
    mov dword [ x_numberDisplay ], dotHex
...
taupeWord:     ; display a taupe word
    call setTaupe
    jmp type_
...
displayShannonFanoActions:  ;    * = number
    ...
    dd taupeWord            ; F     new "string" token
...
actionColourTable:          ;    * = number
    ...
    dd colour_taupe         ; F     new "string" token
...
ekbd0:
    dd silverAction  , blueAction      , taupeAction   , act0         ; a b _ _
...
editorKeyTableHintChars:    ; display the current edit colour and mode in the bottom right hand corner of the keyboard
    ...
    db 0x0B, 0x01, 0x0D, 0x00  ; y r g _    ; yellow red green *toggle            
    db 0x00, 0x00, 0x00, 0x00  ; l u d r    : left up down right                  
    db 0x00, 0x09, 0x0A, 0x00  ; - m c +    ; - magenta cyan +                    
    db 0x00, 0x38, 0x3A, 0x02  ; _ S C t    ; ___ CAPITALS Capital text           
    db 0x00, 0x00, 0x00, 0x00  ; _ _ _ j    ; ___ ___ ___ jump to previous block  
    db 0x08, 0x13, 0x02, 0x00  ; s b t _    ; silver blue taupe ___               

; Editor keypad display
; _ S C t  y r g *
; c d f j  l u d r
; s b t k  - m c +      ; silver blue taupe change-colour
;     x . i

editorKeyboard:         ; the main editor keyboard icons
    db 0x0B, 0x01, 0x0D, 0x2D  ; y r g *    ; yellow red green *toggle
    db 0x0C, 0x16, 0x10, 0x01  ; l u d r    : left up down right
    db 0x23, 0x09, 0x0A, 0x2B  ; - m c +    ; - magenta cyan +
    db 0x00, 0x38, 0x3A, 0x02  ; _ S C t    ; ___ CAPITALS Capital text
    db 0x00, 0x00, 0x00, 0x22  ; _ _ _ j    ; ___ ___ ___ jump to previous block  db 0x00, 0x10, 0x0E, 0x22  ; _ d f j
    db 0x08, 0x13, 0x02, 0x00  ; s b t _    ; silver blue taupe ___
...
version:
    db 'cf2019 1v0 2019Sep14 Chuck Moore' , 0x00    ; 0x20 + 1 bytes
